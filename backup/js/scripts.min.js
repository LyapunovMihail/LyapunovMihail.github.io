...
// header
	...
	$('.header__item').on('click', function(e) {
		if ( !$('body').hasClass('body-fixed') && $(this).has(e.target).length === 0 ) fixedBody();
		if ( $(this).has(e.target).length === 0 ) $('body').addClass('body-fixed');

		if (!$(this).hasClass('header__item_menu')) {
	...
	$('.header__item_menu').on('click', function() {
		...
		if (!$('.header').hasClass('header_menu-open')) {
	...
	$('.header__items-close, .header__tooltip-cls').on('click', function() { // закрытие по клику на темное поле или кнопку
		...
		if ( !$('.header').hasClass('header_menu-open') ) unFixedBody(Number( $('body').css('top').slice(0, -2) ));
		$('.header__item_for-tooltip').removeClass('header__item_for-tooltip');
		$('.header__items-close').removeClass('header__items-close_open');
		if ( !$('.header').hasClass('header_menu-open') ) $('body').removeClass('body-fixed');
	})
