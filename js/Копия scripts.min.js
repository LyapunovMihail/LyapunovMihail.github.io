...
$(document).on('click', '.tooltip__cls-area', function() {
    ...
    $('.tooltip').removeClass('tooltip_open')
});
...
$(document).on('keyup', '.longread-image__title-input, .longread-image__subtitle-input', function() {
...
$(document).on('click', '[data-loading]', function() {
    ...
    $('[data-loading]').addClass('admin-main__output-btn_loading');
    setTimeout(function() {

        $('[data-loading]').removeClass('admin-main__output-btn_loading');
    }, 3000);
});